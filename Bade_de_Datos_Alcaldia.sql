...
CREATE TABLE public.requests (
    ...
    CONSTRAINT requests_status_check CHECK ((status = ANY (ARRAY['En revisión'::text, 'Subsanación'::text, 'Aprobado'::text, 'Rechazado'::text])))
);
...
CREATE TABLE public.users (
    ...
    CONSTRAINT users_role_check CHECK ((role = ANY (ARRAY['Ciudadano'::text, 'Operador'::text, 'Jefe de Departamento'::text, 'Superadministrador'::text])))
);
...
INSERT INTO meta.migrations VALUES ('202407160001', 'embeddings', '2026-06-06 22:28:47.376+00');
...
--
-- Name: requests requests_citizen_id_created_at_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.requests
    ADD CONSTRAINT requests_citizen_id_created_at_key UNIQUE (citizen_id, created_at);
...
--
-- Name: alerts alerts_request_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.alerts
    ADD CONSTRAINT alerts_request_id_fkey FOREIGN KEY (request_id) REFERENCES public.requests(id);
...
ALTER TABLE ONLY public.documents
    ADD CONSTRAINT documents_request_id_fkey FOREIGN KEY (request_id) REFERENCES public.requests(id);
